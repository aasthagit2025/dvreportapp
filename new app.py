...
# --- BUILD SYNC DATAFRAME ---
    ...
    st.download_button(
     label="📥 Download Sync File for Macro",data=processed_data,file_name="macro_sync.xlsx",mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",use_container_width=True
    )
else:
